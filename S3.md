Simple Storage Service (S3): 
    ...
    ➢ You can have up to 10,000 buckets per account. (may expand on request upto 1 million buckets) 
...
STORAGE CLASSES OF AMAZON S3: 
    ...
    7. Amazon S3 S3 Glacier Flexible Retrieval
    8. Amazon S3 Glacier Deep Archive 
    9. Amazon S3 Intelligent Tiering 
